 ...
 * @since 1.0.0
 */
class Felder_Law_Practice_Area extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Practice Area', 'kolegal-addon' );
	}
			...
			while ( $the_query->have_posts() ) {
				...
				<article id="post-<?php the_ID() ;?>" <?php post_class( 'single-service-item' );?>>
					...
					<div class="service-content">
						...
						<a href="<?php the_permalink(  ); ?>" class="learn-btn"><?php echo esc_html__( 'Learn More', 'kolegal' ) ?> <i aria-hidden="true" class="fa fa-arrow-right"></i></a>
					</div>
				</article>
				<?php
			}
