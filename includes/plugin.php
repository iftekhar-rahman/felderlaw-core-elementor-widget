...
final class Plugin {
	 ...
	 * @access private
	 * @static
	 * @var \Felder_Law_Addon\Plugin The single instance of the class.
	 */
	...
	public function custom_categories( $elements_manager ) {
		...
		$elements_manager->add_category(
			'felderlaw',
			[
				'title' => esc_html__( 'Felder Law', 'felderlaw-addon' ),
				'icon' => 'fa fa-plug',
			]
		);
	...
	public function register_widgets( $widgets_manager ) {
		...
		require_once( __DIR__ . '/widgets/practice-area.php' );

		$widgets_manager->register( new \Felder_Law_Addon\Felder_Law_Practice_Area() );
